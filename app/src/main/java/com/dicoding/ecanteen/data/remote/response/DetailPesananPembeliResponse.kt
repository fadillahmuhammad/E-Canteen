...
data class DetailPesananPembeliResponse(

	@field:SerializedName("data_detail_pesanan_pembeli")
	val dataDetailPesananPembeli: DataDetailPesananPembeli? = null,

	@field:SerializedName("status")
	val status: String? = null
)

data class DataDetailPesananPembeli(
