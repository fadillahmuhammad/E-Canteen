...
data class PesananPembeliResponse(

	@field:SerializedName("data_pesanan_pembeli")
	val dataPesananPembeli: List<DataPesananPembeliItem?>? = null,

	@field:SerializedName("status")
	val status: String? = null
)

data class DataPesananPembeliItem(
