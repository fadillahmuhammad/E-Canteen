...
data class HistoryPenjualResponse(

	@field:SerializedName("data_history_penjual")
	val dataHistoryPenjual: List<DataHistoryPenjualItem?>? = null,

	@field:SerializedName("jumlah_pesanan")
	val jumlahPesanan: String? = null,
...
data class DataHistoryPenjualItem(
