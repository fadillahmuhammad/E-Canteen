...
data class HistoryPembeliResponse(

	@field:SerializedName("data_history_pembeli")
	val dataHistoryPembeli: List<DataHistoryPembeliItem?>? = null,
...
data class DataHistoryPembeliItem(
