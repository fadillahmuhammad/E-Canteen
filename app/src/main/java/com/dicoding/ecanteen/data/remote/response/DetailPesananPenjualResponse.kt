...
data class DetailPesananPenjualResponse(

	@field:SerializedName("data_detail_pesanan_penjual")
	val dataDetailPesananPenjual: DataDetailPesananPenjual? = null,

	@field:SerializedName("status")
	val status: String? = null
)

data class DataDetailPesananPenjual(
