...
fun RegisterPenjualScreen(
    ...
    val isStoreNameEmpty = viewModel.storename.value.isEmpty()
        ...
        LazyColumn(
            ...
            item {
                Column(
                    ...
                    Text(
                        text = stringResource(R.string.sign_up_seller),
                    ...
                    TextFieldModel(
                        ...
                        label = stringResource(R.string.enter_your_store_name),
                    ...
                    ButtonModel(
                        ...
                        enabled = !isStoreNameEmpty && !isFullNameEmpty && !isEmailEmpty && !isPasswordEmpty && !isEmailError && !isPasswordError
                    )
...
@Composable
fun RegisterPenjualScreenPreview() {
